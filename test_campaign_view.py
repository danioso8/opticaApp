"""
Script para detectar el error en campaign_list
"""
import os
import django
...
request = factory.get('/dashboard/promociones/campanas/')
...
try:
    ...
    print("\n🔍 Intentando cargar campaign_list...")
    response = views.campaign_list(request)
